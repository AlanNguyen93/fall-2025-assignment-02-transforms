...
This assignment looks at using transforms to robustness test our models in PyTorch.

Perform this assignment in your preferred development environment. It is recommended to use a development container of some form (either through codespaces or through a local devcontainer).

If you need a dependency that is not in the project, use
